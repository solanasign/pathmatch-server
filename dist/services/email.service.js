...
exports.sendOnboardingEmail = exports.sendNotificationEmail = exports.sendAutoResponderEmail = exports.generateAutoResponderEmail = exports.sendRegistrationEmail = void 0;
...
const getDefaultResponsibility = (jobTitle) => {
...
const generateAutoResponderEmail = (jobTitle, applicantName, applicantEmail) => {
...
exports.generateAutoResponderEmail = generateAutoResponderEmail;
// Send auto-responder email
const sendAutoResponderEmail = async (applicantEmail, applicantName, jobTitle) => {
    try {
        const emailContent = (0, exports.generateAutoResponderEmail)(jobTitle, applicantName, applicantEmail);
        const mailOptions = {
            from: process.env.EMAIL_USER || 'info.pathmatch@gmail.com',
            to: applicantEmail,
...
exports.sendAutoResponderEmail = sendAutoResponderEmail;
// Send notification email to PATHMATCH team
const sendNotificationEmail = async (applicantName, applicantEmail, jobTitle, coverLetter, resumeFile) => {
    try {
        const mailOptions = {
            from: process.env.EMAIL_USER || 'info.pathmatch@gmail.com',
            to: 'info.pathmatch@gmail.com',
